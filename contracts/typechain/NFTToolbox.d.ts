...
interface NFTToolboxInterface extends ethers.utils.Interface {
  functions: {
    ...
    "mintExactTokenId(uint256)": FunctionFragment;
    "mintExactTokenIdTo(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "mintExactTokenId",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "mintExactTokenIdTo",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
